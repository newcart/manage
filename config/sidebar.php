...
return [
    'items' => [
        ...
        [
            'name' => 'Siparişler',
            'svg' => '
        <svg xmlns="http://www.w3.org/2000/svg" width="22.525" height="23.631" viewBox="0 0 22.525 23.631">
        ...
        [
            'name' => 'Ürünler',
            'svg' => '
        <svg xmlns="http://www.w3.org/2000/svg" width="18.703" height="26.719" viewBox="0 0 18.703 26.719">
        ...
        [
            'name' => 'Kullanıcılar',
            'svg' => '
            <svg xmlns="http://www.w3.org/2000/svg" width="19.26" height="23.98" viewBox="0 0 19.26 23.98">
        ...
        [
            'name' => 'Kategoriler',
            'svg' => '
        <svg xmlns="http://www.w3.org/2000/svg" width="24.214" height="18.458" viewBox="0 0 24.214 18.458">
        ...
        [
            'name' => 'İçerik',
            'svg' => '
        <svg xmlns="http://www.w3.org/2000/svg" width="16.36" height="19.086" viewBox="0 0 16.36 19.086">
        ...
        [
            'name' => 'Bayilik',
            'svg' => '
        <svg xmlns="http://www.w3.org/2000/svg" width="20.007" height="20.002" viewBox="0 0 20.007 20.002">
