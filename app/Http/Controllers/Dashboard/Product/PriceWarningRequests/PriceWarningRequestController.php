...
namespace App\Http\Controllers\Dashboard\Product\PriceWarningRequests;
...
class PriceWarningRequestController extends Controller
{
    ...
    {
        $this->class = "price-warning-requests";
    ...
    public function index() : Application|Factory|View|RedirectResponse
    {
        ...
        return view('dashboard.products.price_warning_requests.index', $data);
    }
    ...
    public function create() : Application|Factory|View|RedirectResponse
    {
        ...
        return view('dashboard.products.price_warning_requests.create', $data);
    }
