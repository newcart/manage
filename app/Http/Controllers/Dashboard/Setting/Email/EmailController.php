...
namespace App\Http\Controllers\Dashboard\Setting\Email;
...
use App\Http\Controllers\Dashboard\Setting\Utils\Variables;
...
class EmailController extends Controller
{
    ...
    public function index() : Application|Factory|View|RedirectResponse
    {
        ...
        $data = [
            ...
            'datatable' => DatatableComponent::createDatatable($this->class . "s", Variables::EmailColumns())
        ];

        return view('dashboard.settings.email.index', $data);
    }
    ...
    public function create() : Application|Factory|View|RedirectResponse
    {
        ...
        return view('dashboard.settings.email.add-email', $data);
    }
     ...
     * @return Application|Factory|View|RedirectResponse
     */
    public function settings() : Application|Factory|View|RedirectResponse
    {
        if (!User::thisUserHasPermission($this->method, $this->class))
        {
            notify()->warning('Bu işlemi yapmaya yetkiniz bulunmamaktadır', 'Yetki Hatası');
        ...
        return view('dashboard.settings.email.settings', $data);
    }
    ...
    public function edit($id) : Application|Factory|View|RedirectResponse
    {
        ...
        return view('dashboard.settings.email.edit-email', $data);
    }
