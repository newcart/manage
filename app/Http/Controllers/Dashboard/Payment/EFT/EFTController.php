...
namespace App\Http\Controllers\Dashboard\Payment\EFT;
...
use App\Http\Controllers\Dashboard\Content\Utils\Variables;
...
class EFTController extends Controller
{
    ...
    public function index() : Application|Factory|View|RedirectResponse
    {
        ...
        $data = [
            "sidebar" => DashboardComponents::SideBar("dashboard/contents", UserHelper::getType()->code),
            "navbar" => DashboardComponents::Navbar(),
            "datatable" => DatatableComponent::createDatatable($this->class . "s", Variables::ContentColumns())
        ];

        return view('dashboard.payment.eft.index', $data);
    }
    ...
    public function create() : Application|Factory|View|RedirectResponse
    {
        ...
        return view('dashboard.payment.eft.create', $data);
    }
    ...
    public function edit($id) : Application|Factory|View|RedirectResponse
    {
        ...
        return view('dashboard.payment.eft.edit', $data);
    }
