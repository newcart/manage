...
@section('title' , $slide->name . ' Slaytı Düzenle | Akıllıphone')

@section('content')
    <h1>{{ $slide->name }} Slaytını Düzenle</h1>
    <form action="{{ route('dashboard.campaign.slide.update', $slide) }}" method="POST" class="mt-3">
        @csrf
        <div>
            <div class="line">
            ...
            <div class="d-flex flex-wrap gap-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="queue_no" value="{{ $slide->queue_no }}">
                </div>
                <div class="mb-3">
                    <label for="slide_description" class="form-label">Açıklama</label>
                    <input type="text" class="form-control" name="slide_description" value="{{ $slide->description }}">
                </div>
                <div class="mb-3">
                    <label for="slide_time" class="form-label">Slayt Geçerlilik Zamanı</label>
                    <div class="date-picker-area">
                        <input type="text" class="date-picker" readonly placeholder="Tarih" value="{{ $slide->available_time_starts }}">
                        <span>arasında</span>
                        <input type="text" id="date-picker2" placeholder="..." value="{{ $slide->available_time_ends }}">
        ...
        <button type="submit" class="btn btn-primary">Slaytı Kaydet</button>
    </form>
@endsection
