        ...
        <div>
            ...
            <div class="d-flex flex-wrap gap-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="max_single_usage">
                </div>
                <div class="mb-3">
                    <label for="discount_Type" class="form-label">İndirim Tipi</label>
                    @php
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="member_fullname" >
                </div>
                <div class="mb-3">
                    <label for="minimum_limit_amout" class="form-label">Minimum Limit Tutarı</label>
                    <input type="number" class="form-control" name="minimum_limit_amout">
                </div>
                <div class="mb-3">
                    <label for="maksimum_limit_amout" class="form-label">Maksimum Limit Tutarı</label>
                    <input type="number" class="form-control" name="maksimum_limit_amout">
                </div>
                <div class="mb-3">
