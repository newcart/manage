...
@section('content')
    ...
    <form action="{{ route('dashboard.products.colors.store') }}" method="POST" class="mt-3">
        ...
        <div>
            ...
            <div class="d-flex flex-wrap gap-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="queue_no" value="{{ $color->queue_no }}">
                </div>
                <div class="mb-3">
                    <label for="color_code" class="form-label">Renk Kodu</label>
                    <input type="color" class="form-control" name="color_code" value="{{ $color->hex_code }}">
                </div>
                @php
                    $options = [
                        'Renk Grubu',
        ...
        <button type="submit" class="btn btn-primary">Renk bilgisini kaydet</button>
    </form>
@endsection
