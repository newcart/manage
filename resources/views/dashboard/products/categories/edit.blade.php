...
@section('title', $category->name . ' Kategorisini Düzenle - Akıllıphone')

@section('content')
    <h1>{{ $category->name }} adlı kategoriyi düzenliyorsunuz</h1>
    <form action="{{ route('dashboard.categories.update', $category) }}" method="POST" class="mt-3">
        @csrf
        <div>
            <div class="line">
            ...
            <div class="d-flex flex-wrap gap-3">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="queue_no" value="{{ $category->queue_no }}">
                </div>
                <div class="mb-3">
                    <label for="name" class="form-label">Listeleme Sırası</label>
                    <input type="number" class="form-control" name="list_queue" value="{{ $category->list_queue }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="google_category" value="{{ $category->google_category }}">
                </div>
                <div class="mb-3">
                    <label for="queue_no" class="form-label">Menü CSS Sınıfı</label>
                    <input type="text" class="form-control" name="menu_css_class" value="{{ $category->menu_css_class }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="tab_queue" value="{{ $category->tab_queue }}">
                </div>
                <div class="mb-3">
                    <label>Durumu</label>
                    <label class="switch">
        ...
        <div>
            ...
            <div class="d-flex flex-wrap gap-3">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="page_title" value="{{ $category->seo['page_title'] }}">
                </div>
                <div class="mb-3">
                    <label for="code" class="form-label">Anahtar Kelimeler</label>
                    <input type="text" class="form-control" name="keywords" value="{{ $category->seo['keywords'] }}">
                </div>
                <div class="mb-3">
