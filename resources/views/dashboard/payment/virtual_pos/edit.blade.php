        ...
        <div>
            ...
            <div class="d-flex flex-wrap gap-3">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="bank_name" value="{{ $bank->name }}">
                </div>
                <div class="mb-3">
                    <label for="username" class="form-label">Kullanıcı Adı</label>
                    <input type="text" class="form-control" name="username" value="{{ $bank->username }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="terminal_no" value="{{ $bank->terminal_no }}">
                </div>
                <div class="mb-3">
                    <label for="min_hire_purchase_amount" class="form-label">Minimum Taksit Tutarı</label>
                    <input type="text" class="form-control" name="min_hire_purchase_amount" value="{{ $bank->min_hire_purchase_amount }}">
                </div>
                <div class="mb-3">
                    ...
                    <select name="otorization_type">
                        @foreach($otorization as $value => $option)
                            @if($bank->otorization_type == $value)
                                <option value="{{ $value }}" selected>{{ $option }}</option>
                            @endif
                            <option value="{{ $value }}">{{ $option }}</option>
                        @endforeach
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="purchase_amount" value="{{ $bank->purchase_amount }}">
                </div>
                <div class="mb-3">
                    <label for="purchase_amount_2" class="form-label">Ödeme Ücreti 2</label>
                    <input type="text" class="form-control" name="purchase_amount_2" value="{{ $bank->purchase_amount_2 }}">
                </div>
                <div class="mb-3">
                    <label for="purchase_amount_limit" class="form-label">Ödeme Ücreti 2 Sınırı</label>
                    <input type="text" class="form-control" name="purchase_amount_limit" value="{{ $bank->purchase_amount_limit }}">
                </div>
                <div class="mb-3">
