...
{{--            </div>--}}
            ...
            <div class="d-flex flex-lg-row gap-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="date-picker">
                        <input type="text" id="date-picker" readonly placeholder="Doğum Tarihi">
                    </div>
                </div>
                <div class="mb-3">
        ...
        <div>
            ...
            <div>
                <label class="form-label">
                    Kredi Kartı
                    <input type="checkbox" class="form-control" name="credit_card">
                </label>
            </div>
            <div>
                <label class="form-label">
                    Havale EFT
                    <input type="checkbox" class="form-control" name="eft">
                </label>
            </div>
            <div>
                <label class="form-label">
                    Kapıda Nakit
                    <input type="checkbox" class="form-control" name="cash_on_door">
                </label>
            </div>
            <div>
                <label class="form-label">
                    PayU ile Ödeme
                    <input type="checkbox" class="form-control" name="payu">
                </label>
            </div>
            <div>
                <label class="form-label">
                    Moto-kurye ile Ödeme
                    <input type="checkbox" class="form-control" name="driver_pay">
                </label>
            </div>
            <div>
                <label class="form-label">
                    Dropshipping
                    <input type="checkbox" class="form-control" name="dropshipping">
                </label>
            </div>
        </div>
    </form>
